...
\foreach \i in {0, 7} {
  \foreach \j in {0, 3, 4} {
    ...
    \fi
    \draw[very thick, blue!60] (\i+\j+0.5, 0*1.5+1-\lborder) -- (\i+\j+0.5, 0*1.5+1+2*\lborder);
    }
  \draw[very thick, blue!60] (\i+0.5, 0*1.5+1+2*\lborder) -- (\i+4.5, 0*1.5+1+2*\lborder);
}
%downwards ones
\foreach \i in {2} {
  \foreach \j in {0, 3, 4} {
    ...
    \else 
      \thickdotshape{blue!10}{blue!60}{\i+\j}{0*1.5}{0.35}
    \fi
    \draw[very thick, blue!60] (\i+\j+0.5, 0*1.5-2*\lborder) -- (\i+\j+0.5, 0*1.5+\lborder);
    }
  \draw[very thick, blue!60] (\i+0.5, 0*1.5-2*\lborder) -- (\i+4.5, 0*1.5-2*\lborder);
}
