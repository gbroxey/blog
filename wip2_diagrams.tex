...
\draw[line width=2pt, blue!60] (0.5, 0*1.5+1-\lborder) -- (0.5, 0*1.5+1+2*\lborder) -- (2.5, 0*1.5+1+2*\lborder) -- (2.5, 0*1.5+1-\lborder);
\draw[line width=2pt, blue!60] (2.5, 0*1.5+1+2*\lborder) -- (3.5, 0*1.5+1+2*\lborder) -- (3.5, 0*1.5+1-\lborder);
...
\draw[line width=2pt, blue!60] (5.5, 0*1.5+1-\lborder) -- (5.5, 0*1.5+1+2*\lborder) -- (7.5, 0*1.5+1+2*\lborder) -- (7.5, 0*1.5+1-\lborder);
\draw[line width=2pt, blue!60] (7.5, 0*1.5+1+2*\lborder) -- (8.5, 0*1.5+1+2*\lborder) -- (8.5, 0*1.5+1-\lborder);
...
\draw[line width=2pt, blue!60] (9.5, 0*1.5+1-\lborder) -- (9.5, 0*1.5+1+2*\lborder) -- (11.5, 0*1.5+1+2*\lborder) -- (11.5, 0*1.5+1-\lborder);
\draw[line width=2pt, blue!60] (11.5, 0*1.5+1+2*\lborder) -- (11.6, 0*1.5+1+2*\lborder);
\draw[line width=2pt, blue!60] (11.7, 0*1.5+1+2*\lborder) -- (11.8, 0*1.5+1+2*\lborder);
\draw[line width=2pt, blue!60] (11.9, 0*1.5+1+2*\lborder) -- (12, 0*1.5+1+2*\lborder);
...
%DIAGRAM OF {1, p^3, p^4}
%onedim-2.svg

\begin{center}
\begin{tikzpicture}[scale=1.5, every node/.style={scale=1.25}]
\begin{scope}[xshift=-0.5cm,yshift=-0.5cm]
\fill[white!100] (0,0) -- (12, 0) -- (12, 1) -- (0, 1) -- cycle;
\draw (0,0) grid (12, 1);
\draw[very thick] (0,0) -- (12, 0) -- (12, 1) -- (0, 1) -- cycle;

% \thickdotshape{black!15}{black!60}{1}{0*1.5}{0.2}
% \thickdotshape{black!15}{black!60}{2}{0*1.5}{0.2}

%upwards ones
\foreach \i in {0, 7} {
  \foreach \j in {0, 3, 4} {
    \if \j 0
      \thickdotshape{blue!25}{blue!60}{\i}{0*1.5}{0.75}
    \else 
      \thickdotshape{blue!10}{blue!60}{\i+\j}{0*1.5}{0.35}
    \fi
    \draw[line width=2pt, blue!60] (\i+\j+0.5, 0*1.5+1-\lborder) -- (\i+\j+0.5, 0*1.5+1+2*\lborder);
    }
  \draw[line width=2pt, blue!60] (\i+0.5, 0*1.5+1+2*\lborder) -- (\i+4.5, 0*1.5+1+2*\lborder);
}
%downwards ones
\foreach \i in {2} {
  \foreach \j in {0, 3, 4} {
    ...
    \else 
      \thickdotshape{blue!10}{blue!60}{\i+\j}{0*1.5}{0.35}
    \fi
    \draw[line width=2pt, blue!60] (\i+\j+0.5, 0*1.5-2*\lborder) -- (\i+\j+0.5, 0*1.5+\lborder);
    }
  \draw[line width=2pt, blue!60] (\i+0.5, 0*1.5-2*\lborder) -- (\i+4.5, 0*1.5-2*\lborder);
}
